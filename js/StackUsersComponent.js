...
StackUsersComponent.prototype.show = function(){
    ...
    var onError = function(errorResponse, context){
        $("#" + context.renderElementId).append("<p>Unable to retrieve users from " + context.site + "</p>");
    };
    
    this.stackService.getRoute().UsersById(this.stackService.users).getResponse(onSuccess, onError, 5000, this);
};
